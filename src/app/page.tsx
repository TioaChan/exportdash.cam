        ...
        {sequences.length === 0 ? (
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              {/* Open Source */}
              <div className="bg-gray-900/50 rounded-xl p-5 border border-gray-800 relative overflow-hidden">
                <svg className="absolute -right-2 top-2 w-20 h-20 rotate-6 opacity-30 pointer-events-none" viewBox="0 0 256 256">
                  <circle cx="128" cy="128" r="113" fill="none" stroke="currentColor" strokeWidth="15"/>
                  <text x="128" y="148" textAnchor="middle" fill="currentColor" fontSize="100" fontWeight="bold" fontFamily="Arial">MIT</text>
                </svg>
                <div className="relative z-10">
